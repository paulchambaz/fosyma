...
public class DummyMovingAgent extends AbstractDedaleAgent {
  ...
  /**
   * This method is automatically called before migration. You can add here all the saving you need
   */
  ...
  /**
   * This method is automatically called after migration to reload. You can add here all the info
   * regarding the state you want your agent to restart from
   */
