...
/**
 * 
 * This Wumpus is harmless. It moves randomly and shift the resources it
 * encounters
 * 
 * 
 * @author hc
      ...
      if (pause) {
        ...
        if (myPosition != null) {
          ...
          if (grabbed && currentWaitingTimeBeforeDromOff == 0) {
            ...
            // System.out.println("I try to open the safe: "+((AbstractDedaleAgent)
            // this.myAgent).openLock(Observation.ANY_TREASURE));
            ...
            for (Couple<Observation, String> o : lObservations) {
              switch (o.getLeft()) {
                ...
                // System.out.println("Value of the treasure on the current position:
                // "+o.getLeft() +": "+ o.getRight());
                // System.out.println("The agent grabbed :"+((AbstractDedaleAgent)
                // this.myAgent).pick());
                ...
                case GOLD:
                  // System.out.println("My treasure type is : "+((AbstractDedaleAgent)
            ...
            // lobs2=((AbstractDedaleAgent)this.myAgent).observe();//myPosition
