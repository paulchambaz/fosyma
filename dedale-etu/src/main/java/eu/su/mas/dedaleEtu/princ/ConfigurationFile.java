...
/**
 * Configuration file for a Dedale instance 1) Network and platform parameters 2) Environment
 * parameters
 *
 * @author hc
 */
public final class ConfigurationFile {
  ...
  public static Integer OPTIONAL_ADDITIONAL_ENVGENERATOR_PARAM1 =
      1; // used by the BARABASI_ALBERT generator to know the number of childs
